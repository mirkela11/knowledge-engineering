...
symptom(painful_ejaculation, [0]).
symptom(pain_or_burning_while_urinating, [0, 2, 6, 7]).
...
% urine
symptom(frequent_urinating, [0, 3, 6, 7]).
symptom(trouble_urinating, [0, 1, 2]).
